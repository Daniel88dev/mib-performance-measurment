...
/**
 * Process CSV file client-side and aggregate performance measurements
 * This runs in the browser to avoid Vercel's 4.5MB serverless function payload limit
 */
export async function processCsvFileClient(file: File): Promise<ProcessedCsvResult> {
